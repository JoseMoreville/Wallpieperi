<template>
  <video
    ...
    muted 
    loop
    class=" w-1/4 h-1/6 rounded-lg object-cover antialiased hover:brightness-110 hover:shadow-lg  hover:shadow-cyan-500/50 aspect-video	ring-1 ring-slate-600/5"
